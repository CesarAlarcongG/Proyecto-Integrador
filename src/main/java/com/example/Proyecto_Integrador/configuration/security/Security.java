package com.example.Proyecto_Integrador.configuration.security;
...
import com.example.Proyecto_Integrador.service.JwtService;
...
public class Security {
    ...
    public UserDetailsService userDetailsService() {
        return username -> administradorRepository.findByCorreo(username)
